 ...
 */
const routes: Routes = [
  // The migration comparison route retired 2026-09-01 with the archetypes
  // it existed to compare against - twice over: once for the twelve
  // original pages, once for the fourteen archetypes.
