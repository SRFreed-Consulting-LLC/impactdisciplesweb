...
@Component({
  selector: 'app-registration-attendees',
  templateUrl: './registration-attendees.component.html',
  styleUrls: ['./registration-attendees.component.scss']
})
export class RegistrationAttendeesComponent implements OnInit, OnDestroy {
